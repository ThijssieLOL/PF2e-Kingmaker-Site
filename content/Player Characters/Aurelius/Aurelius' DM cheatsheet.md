...
- **[[Vespera]] — The Mind:** argues his grand theories down to frontier logistics.
...
- **The Real Reason He Was Sent:** Church high command approved the assignment partly to hide him from the cabal ([[Aurelius#Call to the Frontier: Mission to the Stolen Lands]]).
- **The Whispers:** the entities that called him stayed invisible even to the [[Ocular of Kaelen]], and he has no name for their order ([[Spirits#Rank]]).
- **Tristan:** whether he died is not known ([[Tristan#The Horde & The Open Question]]).
- **His Parents:** dead before he could learn what they knew of the prophecy ([[Ocular of Kaelen#The Murder of Aurelius's Parents]]).

---

## Mechanics at the Table

- **The Eclipse Trigger:** unsalvageable cruelty, severe blasphemy, or deep personal trauma flips him into a flat, clinical executioner; he needs isolation to come back, then apologises to anyone he frightened ([[Aurelius#Trauma Response: "The Eclipse"]]).
- **Casting Cost:** heat floods his body, and if his focus breaks the magic recoils as severe fatigue and pain ([[Aurelius#Spellcasting]]).
- **The Visual Tells:** his [[Tattoos of Penance]] ignite Aureolin White, and the [[Ocular of Kaelen]] shifts into a rotating kaleidoscope ([[Ocular of Kaelen#Active State]]).
- **The Silent Speech:** speaking with spirits, his lips move on a frequency no human ear catches ([[Aurelius#Daily Habits & Quirks]]).
...
- **Status:** Draft. This page is a DM tool, not wiki canon, and its `draft` flag keeps Quartz from building it.
- **Source of truth:** each knife is owned by the page it links to. Where this line and that page disagree, that page wins.
- **Link rule:** do not link this page from a published note, or the link breaks on the site.
