...
| Covert Persona | Divine commando and spirit-binder |
...
| Occasion | Kit |
| :------- | :-- |
| Civilian & ceremonial | The Grade 8 Cinder vestment of [[The Vestments of the Clergy]]. *(Work in progress.)* |
| Travel & frontier | Cut for the rugged terrain of the Stolen Lands: durable black trousers and a fitted dark tunic under a loose, flowing, hooded white poncho-capelet, carrying the same gold-embroidered solar trim as his formal stole. Balances practical movement with holy symbolism. |
...
> [!warning] The Eclipse
> **The Executioner Persona:** When he meets unsalvageable cruelty, severe blasphemy, or deep personal trauma, Aurelius enters a total psychological shutdown. His gentle warmth vanishes, replaced by a terrifying, cold, emotionless executioner state.
>
> **Internal Shame:** He does not consider it a holy state. He sees it as a sinful lapse into trauma-driven survival instincts, where divine mercy gives way to raw, cold violence.
>
...
Aurelius fights at mid to long range as a caster, shaping his spells through the [[The Star Seals|Star Seals]] and turning attacks aside with kinetic redirection. His bound apparitions extend his reach and hold ground he gives up, and commando training left him able to fight and defend himself at close quarters, though that is a fallback rather than his style. The detachment underneath it holds until the brink of death, where it breaks into a brutal, desperate fight to survive.
...
### The Streets of Restov
Orphaned, he survived on the streets from six to eight, where hunger drove him to theft and assault, and finally to the assassination of a profoundly evil man and the murder of the man's innocent family to eliminate all witnesses, acts that permanently scarred his soul.
...
| Name | Role | Circle | Dynamic |
| :--- | :--- | :----- | :------ |
| [[Lucian\|Father Lucian Soler]] | The Mentor & Father Figure (Grade 7 Warpriest) | Church clergy | Head instructor within [[The Chancellery of Silent Illumination]] and Aurelius's tactical instructor, who worked with him to forge his Animist combat style. A paternal anchor and protector against the ocular-hunting cabal, he gave Aurelius his personal combat talisman before the Stolen Lands and keeps in touch through encrypted Church missives. |
| [[Tristan]] | The Shield (Champion) | The fallen | The protective older-brother figure of the class and Aurelius's closest listener, the one he could speak to about ordinary things when he could speak to no one else. Lost holding back a monstrous horde so his siblings could escape; whether he died is not known. Aurelius holds his memory as the highest standard of holy sacrifice, and he often blames himself for the loss. |
| [[Valerius]] | The Vanguard (Fighter) | The fallen | Impulsive and fiery, Valerius bickered with Aurelius over discipline versus instinct, and his death at the city walls reminds Aurelius of the brutal cost of war. |
| [[Gideon]] | The Anchor (Warpriest) | The living | The emotional heart of the group, he embodies the sun goddess' healing grace. Gideon keeps a close eye on Aurelius's mental health, gently pulling him back to humanity whenever he slips into "The Eclipse." |
| [[Julian]] | The Wit (Swashbuckler) | The living | Charismatic, theatrical, and quick-witted, Julian uses humor and playful banter to keep Aurelius grounded and break his somber moods. |
| [[Vespera]] | The Mind (Investigator) | The living | Analytical, quiet, and razor-sharp, Vespera is Aurelius's intellectual counterpart. She regularly challenges his grand political theories with practical logic and tactical realism. |
| [[Lyra]] | The Catalyst (Alchemist) | The living | A chaotic genius obsessed with sacred alchemy, Lyra is Aurelius's primary collaborator on the [[Holy Ground Project]], turning his spiritual theories into physical alchemical instruments. |
...
- Layout test for [[Aurelius]]. Not canon, not published (`draft: true`).
- Hypothesis: the three levers work best in combination. Pick the containers that carry structure (tables), the boxes that carry emphasis (callouts), and the rhythm that carries the prose (granular sections), and leave the rest alone.
- From Test 1: Quick Facts and the Attire kit are tables, and the relationships are one roster table with a `Circle` column.
- From Test 2: the top quote is a `quote` callout, the [[Ocular of Kaelen]] sits in an `info` callout, and "The Eclipse" sits in a `warning` callout.
- From Test 3: History is split into six named stages rather than four long sections, and no paragraph was shortened to fit a rule.
- Deliberately left out: the italic section leads from Test 3, and the `todo`, `example`, `note`, and `danger` callouts from Test 2. Fewer moving parts, so the keep-or-cut judgement is easier.
