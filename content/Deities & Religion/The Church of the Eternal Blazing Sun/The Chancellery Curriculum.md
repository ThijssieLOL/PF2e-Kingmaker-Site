...
The Curriculum ties study to grade, and each step of the climb is measured against the schooling of the wider world. One step stands at the level of a general education, the next at a bachelor's, then a master's, and at the top a doctorate. The qualification attaches to the chancellery rather than to the member alone, so a cleric carries a separate degree in the field of every chancellery they serve, and the bar rises with each grade.

Read as a series of transitions, the ladder shows what each step up is worth in the wider world:

| Transition | In the wider world | What the member earns |
| :--------- | :----------------- | :-------------------- |
| **Grade 9 → Grade 8** | A high school diploma | General education, the schooling a member completes before specialising in a chancellery |
| **Grade 8 → Grade 7** | A bachelor's degree | A bachelor's in the track the member takes up on specialising |
