...
- **Anathema of Undeath:** The church is fiercely opposed to the undead. Doctrine teaches that they are entirely soulless, and that to create an undead creature, or to allow one to be created, is a horrific insult to the deceased: it traps their physical vessel in a mocking half-existence and keeps their soul from finding true rest.
...
The church runs a formal archdiocese system adapted to the world's geography. Regional bishops and archbishops manage local parishes and keep direct communication with the central headquarters. It sites its houses with care, placing each to reach the most people for the resources spent, so every church's tier tracks the population it serves.
...
- **Veto Triggers:** The Moral Veto is triggered by capital sins:
...
The common greeting is the Solar Circle: drawing a large, counterclockwise circle over the chest with the right thumb, index, and middle fingers pinched together, accompanied by the phrase *"Praise the sun."* Worshippers answer with one of several liturgical responses:
...
- Third layout comparison copy of [[The Church of the Eternal Blazing Sun]]. Draft only; not wiki canon.
- Selective bullets: a list is kept only where the section holds a set of parallel, scannable facts (doctrines, stances, triggers, responses, threat categories, placeholders, Quick Facts, and the chancellery table). Prose carries anything narrative, historical, or explanatory.
- Layout deltas from the live page: a `---` break between top-level sections, and `Grade 9-0` written with a hyphen.
