...
4. Set your username in command prompt: git config --global user.name "FIRST_NAME" (From)
...
7. Go to directory where you want to save the obsidian vault: Cd INSERT-PATH-HERE
