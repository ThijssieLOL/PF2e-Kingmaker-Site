...
tags:
  ...
  - governance
aliases:
  - Church and State Brainstorm
  - Church versus State
---

# Church and State Brainstorm

> Working document. This is not canon. It sits outside `content/`, so Quartz never publishes it. It gathers what the canon already says about the Church behaving like a state, draws the line as it stands today, and lists the questions still open, ready to answer later.

## The idea (verbatim braindump)

> This does make me want to brainstorm what the differences between a state and the organization of the church are. Of course my idea of the church is largely inspired by the medieval roman catholic church which had all these things, but still I am curious about brainstorming the distinction between the church and a state

## What it touches

The hub page carries the tension in two sentences. The Church "runs its affairs with the scale and discipline of a sovereign empire," and its nine High Chancelleries each "govern a distinct pillar of statecraft, divine law, and civil service." Yet the same page says it "does not seek to rule nations directly" and holds "a strict apolitical stance on state governance." Both readings are canon, so the question is where one ends and the other begins.

The notes that speak to it:

- [[The Church of the Eternal Blazing Sun]] — the Radiant Mandate, the apolitical stance, the Moral Veto, and the chancellery table.
- [[The Chancellery of the Purifying Flame]] — ecclesiastical courts, internal purges, and the Moral Veto's triggers and protocol.
- [[The Chancellery of the Shared Hearth]] and [[The Shared Hearth Economy]] — tithes, treasury, charity, and the rules that the Church owns no means of production and runs no banks.
- [[The Chancellery of Celestial Aegis]] — the Church's armed forces and its holy wars.
- [[The Chancellery of the Meridian Cadastre]] and [[The Ember Post]] — registries, archives, and the messenger service.
- [[The Chancellery of Sacred Canon]] and [[The Church Schooling Program]] — schools and examinations.
- [[The Chancellery of Consecrated Solace]] — hospitals, disaster relief, and the cremation rites.
- [[The Chancellery of Silent Illumination]] — espionage and internal oversight.
- [[The Chancellery of the Outer Horizon]] — diplomacy with sovereign nations.
- [[Church Tiers]] and [[The Grade System]] — parishes, archdioceses, and the hierarchy.
- [[Trias Politicas]] — the Church holding a constitutional Moral Veto inside Aurelius's kingdom.

## State-like functions already in canon

The Church already does most of what a state does. The table gathers each function and the note that owns it, so the two halves can be compared at a glance.

| Function | Held by | Where it is written |
| :------- | :------ | :------------------ |
| Taxation (tithes on spendable income) | [[The Chancellery of the Shared Hearth]] | [[The Shared Hearth Economy]] |
| Treasury and investment | [[The Chancellery of the Shared Hearth]] | [[The Shared Hearth Economy]] |
| Charity and public relief | [[The Chancellery of the Shared Hearth]] | [[The Shared Hearth Economy]] |
| Courts and internal justice | [[The Chancellery of the Purifying Flame]] | [[The Chancellery of the Purifying Flame]] |
| Authority over corrupt rulers (Moral Veto) | [[The Chancellery of the Purifying Flame]] | [[The Chancellery of the Purifying Flame]] |
| Excommunication and capital punishment | [[The Chancellery of the Purifying Flame]] | [[The Chancellery of the Purifying Flame]] |
| Armed forces and holy war | [[The Chancellery of Celestial Aegis]] | [[The Church of the Eternal Blazing Sun]] |
| Espionage, state security, internal oversight | [[The Chancellery of Silent Illumination]] | [[The Chancellery of Silent Illumination]] |
| Registries and archives | [[The Chancellery of the Meridian Cadastre]] | [[The Chancellery of the Meridian Cadastre]] |
| Messenger service (the Ember Post) | [[The Chancellery of the Meridian Cadastre]] | [[The Ember Post]] |
| Schools and the schooling program | [[The Chancellery of Sacred Canon]] | [[The Church Schooling Program]] |
| Examinations and advancement | [[The Chancellery of Sacred Canon]] | [[The Grade System]] |
| Hospitals, relief, and cremation | [[The Chancellery of Consecrated Solace]] | [[The Church of the Eternal Blazing Sun]] |
| Diplomacy and foreign missions | [[The Chancellery of the Outer Horizon]] | [[The Church of the Eternal Blazing Sun]] |
| Research | [[The Chancellery of Prismatic Inquiry]] | [[The Church of the Eternal Blazing Sun]] |
| Territorial administration (parishes, archdioceses) | The grade hierarchy | [[Church Tiers]] |
| A leader chosen outside any mortal process | Grade 2, named by the goddess | [[The Grade System]] |

## Where the Church stops short of a state
...
A state governs a territory and everyone on it, by law backed by force. The Church governs its own members and its own houses, by doctrine, and reaches beyond them only where doctrine says a ruler has crossed a line. On paper that is a clean split.

In practice, the Church runs schools, hospitals, courts, an army, an intelligence arm, a treasury, a registry, and a courier service. That is a state's apparatus with the land left out. The open question this document exists to answer is whether the Church is borrowing a state's tools to serve a mission, or whether it is a state that has chosen not to annex.
...
12. The Church keeps an army and has fought holy wars. Under whose flag does it march: its own, or a host state's?
13. The Silent Illumination runs espionage and internal oversight. Is that a state's intelligence service by another name, and how does it square with the apolitical doctrine?
14. Where a state bans the faith, what is the Church there: outlawed, an underground church, or an unrecognised mission?

**The apolitical stance and the veto**

15. The ban on crowns, rule, and office: is it doctrine, law, treaty, or all three?
16. Who enforces the ban on the Church's own clergy, and what is the penalty for a cleric who takes a crown?
17. Does the ban bind only clergy, or lay solites who hold office as well?
18. What exactly does the Moral Veto authorise once issued, and must a ruler obey it? The Purifying Flame page already sets who may issue one (any Grade 7 and up may start it, and it needs a group of Grade 6 or one Grade 5); what it binds is still open.
19. Is the Moral Veto a legal power that states have agreed to, or a moral claim the Church enforces by its own means?
20. Can the Church be wrong about a veto? Is there any appeal, and who would hear it?

**How the world sees it**

21. Do secular rulers see the Church as a rival sovereign, a partner, or a threat?
22. Does the Church want believers or subjects? Could it become a state, or would that break its own doctrine?
23. Where does [[Aurelius]]'s fledgling kingdom in the Stolen Lands sit against all this: a banned realm, a host, or a future partner?
