...
tags:
  ...
  - design
aliases:
  - Apparition Design Brainstorm
  - Spirit Design Brainstorm
---

# Apparition Design Brainstorm

> Working document. This is not canon. It keeps only the settled points and the spirit designs that were liked.
...
- **The spirits are cursed spirits, in the vein of JJK curses.** The register is cursed-spirit horror, played eerie. The designs are grotesque and confrontational: wrong bodies, misplaced human features, exposed anatomy. They should be scary, cool, and visibly powerful. But the fright is often calm rather than aggressive. The model is the stag: it does not menace, it grazes, and that is worse.
...
### The body is the appearance

The main body of text under each spirit is a detailed description of how it looks. Appearance is the part being worked out at the moment: silhouette, scale, body plan, surface and texture, how it moves, and the one detail that is wrong. Behaviour, origin, and story come later. Until then they wait in the bullet fields, so nothing is lost and nothing has to be rewritten.

### Every entry names the spirit and its family

Every heading carries three things, in this order: the spirit's own name, the apparition family it belongs to, and its level with the spell that level carries.
...
A stag the height of a barn. Its antlers are a grove: real trees, bark and leaf and root, grown out of the skull and spreading wider than the animal is long. The ribcage stands open at the front and is packed with eyes, wet and amber, pressed so tightly against each other that the whole mass shifts when it breathes. It walks on too many legs, more than can be counted while it is walking, and the legs are not all deer. The coat is the brown of winter woods and carries old scars the way bark carries them.
...
A drowned man hangs upright in the air at the height he hung in the water, and the air holds him the way the water did. His clothes are a sailor's, gone soft and green, and they move as if the water were still there. Kelp trails from his ankles and out of his hair. His face is turned down, the way a floating man's face hangs in the water, so nothing of it shows but the back of his head. His arms hang toward the dark under him, reaching at nothing. He is the only part of it that is ever seen. Under him the water, or the mud, or the dark between the roots, is darker than it should be, and it does not move the way water moves.

Nothing that comes for the drowned man sees what answers. A tendril comes up out of the ground, black and wet, the width of a finger and the length of a mast, and it closes on the target and drags it under. The surface closes over both of them. The tendril shows itself for as long as that takes, and never what it is attached to, so the whole of it anyone has seen is a water monster's tendril: a kraken's trick worked small, in water too shallow to hold anything that size, and it works because the dark is the only part of it nobody can look into.
...
- **Behaviour:** It drifts the lure where the dark is deepest, waits below, and takes from underneath. The drowned man reaches down into it the whole time, at nothing.
...
A person standing in a room, and there is nothing in the room. It is only ever there in glass. In a mirror, in a dark window, in a still bucket of water, it is a figure standing behind whoever is looking, close enough to touch. No two people see the same figure, because it takes the shape of the person they fear most. It is always smiling. The smile does not match the face it is wearing, and it does not move. It does not move while it is being watched, and it does not appear in glass that nobody is looking into. Paintings of a room it has stood in show a shoulder that no one painted.

- **Body plan:** Humanoid, glass-bound.
- **Signature wrongness:** It wears the shape of the person the watcher fears most, and it is always smiling.
...
*Built on the Piper of The Magnus Archives (MAG 7): the three faces, the many arms, the tattered olive coat, and the body that is only wounds.*

It is no taller than a man. It has three faces set into the one head, and each of them is busy with something else. The first plays the pipes. The second screams, and the scream is the cry it made when it died. The third keeps its mouth shut, and it will not open it, because what falls out when it does is blood and sodden soil, coming down like a waterfall. The pipes are scrimshawed bone, carved over in fine lines, and the drones rise past its shoulder into the smoke that comes with it.

The arms are the part that does not fit the man. There are many of them, and only two play the pipes. The rest are gripping things: blades, guns, spears. Some are held up with the palms out, in the gesture a man makes when he is begging. One is in a crisp salute and does not move. It wears a tattered coat of wool, olive green where the coat is not stained black, and under the coat there is no body to see. There is only what was done to it: beaten, slashed, and shot until nothing is left but the wounds.

- **Body plan:** Humanoid, man-sized.
